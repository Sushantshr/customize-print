  ...
  return (
    <div className="print-order-container">
      <div className="print-btn">
        <button onClick={handlePrint}>🖨️ Print T-shirt Orders</button>
      </div>
      ...
      <div className="bill-container">
        ...
        {/* Order 2 - Tshirt (duplicate of Order 1) */}
        <div className="order-container">
          <div className="inside-container">
            <div className="left">
              <div className="section-title">Order Details</div>
        ...
        {/* Order 3 - Tshirt (duplicate of Order 1) */}
        <div className="order-container">
          <div className="inside-container">
            <div className="left">
              <div className="section-title">Order Details</div>
...
export default TshirtPrintOrderPage;
